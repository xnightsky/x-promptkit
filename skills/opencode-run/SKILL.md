...
Construct exactly one `opencode run` command for the requested task. Keep the user's scope tight, preserve the original Chinese meaning, and add only the minimum escaping needed for a runnable shell command.
