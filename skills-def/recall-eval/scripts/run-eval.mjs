...
if (yamlPaths.length === 0) {
  console.log(
    "Usage: node skills-def/recall-eval/scripts/run-eval.mjs <yaml-path|target-path> [<yaml-path|target-path> ...] [--case <id>] [--answer <text> | --answer-file <path> | --answers-file <json-path> | --live]",
  );
  process.exit(1);
}
